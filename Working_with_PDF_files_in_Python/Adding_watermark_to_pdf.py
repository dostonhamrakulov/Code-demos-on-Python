...
def add_watermark(wmFile, pageObj):
    # Step_1: opening watermark pdf file
    wmFileObj = open(wmFile, 'rb')

    # Step_2: creating pdf reader object of watermark pdf file
    pdfReader = PyPDF2.PdfFileReader(wmFileObj)

    # Step_3: merging watermark pdf's first page with passed page object.
    pageObj.mergePage(pdfReader.getPage(0))

    # Step_4: closing the watermark pdf file object
    wmFileObj.close()

    # Step_5: returning watermarked page object
    return pageObj
